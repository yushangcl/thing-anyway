...
public class RabbitConfig {
     ...
     * 延迟队列 TTL 名称
     */
    private static final String REGISTER_DELAY_QUEUE = "thing.register.delay.queue";
    /**
     * DLX，dead letter发送到的 exchange
     * TODO 此处的 exchange 很重要,具体消息就是发送到该交换机的
     */
    public static final String REGISTER_DELAY_EXCHANGE = "thing.register.delay.exchange";
    /**
     * routing key 名称
    ...
    public static final String REGISTER_QUEUE_NAME = "thing.register.queue";
    public static final String REGISTER_EXCHANGE_NAME = "thing.register.exchange";
